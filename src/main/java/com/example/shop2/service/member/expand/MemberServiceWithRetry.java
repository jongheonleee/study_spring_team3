package com.example.shop2.service.member.expand;

import static com.example.shop2.error.GlobalErrorCode.RetryFailed;
import static com.example.shop2.error.member.MemberErrorCode.DuplicatedEmail;
...
public class MemberServiceWithRetry implements MemberService {
    ...
    private final int RETRY_DELAY = 1_000; // 10초
